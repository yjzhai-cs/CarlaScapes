...
if __name__ == '__main__':
    xml_file = PROJECT_DIR / 'outputs' / 'Town03' / 'Town03_000015_5529800_bounding_box.xml'  # PASCAL VOC format XML file path
    image_path = PROJECT_DIR / 'outputs' / 'Town03' / ('Town03_000015_5529800_img.png') # Corresponding image file path)
